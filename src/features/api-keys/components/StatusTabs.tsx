 ...
 * as MUI tabs (`KEY_STATUS_TABS` / `POLICY_SCOPE_TABS` / `POLICY_TRAINING_TABS`
 * in `ApiKeys.data.ts`). Feature-local rather than promoted to the shared UI
 * kit: nothing else in this app filters by more than a search box and a
 * single dropdown today, so a shared primitive would be speculative.
 */
